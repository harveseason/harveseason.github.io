      ...
      <li class="tl-org reveal">
        ...
        <div class="role-track">
          <div class="tl-role">
            ...
            <div class="focus">UX Strategy · Product Design · UI Design · Design System</div>
          </div>
          <div class="tl-role">
            ...
            <div class="focus">UX Design · UI Design · Prototyping · User Research</div>
          </div>
          <div class="tl-role">
      ...
      <li class="tl-org reveal">
        ...
        <div>
          <div class="tl-role">
            ...
            <div class="focus">Campaign Website · Visual Design · RWD · Art Direction · Digital Design</div>
          </div>
        </div>
      </li>
    </ol>
